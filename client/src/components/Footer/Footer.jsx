    ...
    <div className="footer">
      <footer className="bg-dark text-center text-white">
        ...
        <div className="text-center p-3">
          © 2022 Страницу верстал:
          <a className="text-white" href="https://mdbootstrap.com/">Алишер Ауельбеков</a>
        </div>
      </footer>
    </div>
  )
